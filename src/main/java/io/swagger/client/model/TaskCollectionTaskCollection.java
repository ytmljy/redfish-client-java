...
import io.swagger.client.model.TaskTask;
...
public class TaskCollectionTaskCollection   {
  ...
  private List<TaskTask> members = new ArrayList<TaskTask>();
  ...
  /**
   **/
  public TaskCollectionTaskCollection odataContext(Odata400Context odataContext) {
  ...
  /**
   **/
  public TaskCollectionTaskCollection odataId(Odata400Id odataId) {
  ...
  /**
   **/
  public TaskCollectionTaskCollection odataType(Odata400Type odataType) {
  ...
  /**
   **/
  public TaskCollectionTaskCollection description(ResourceDescription description) {
   ...
   **/
  public TaskCollectionTaskCollection members(List<TaskTask> members) {
  ...
  public List<TaskTask> getMembers() {
    return members;
  }
  public void setMembers(List<TaskTask> members) {
    this.members = members;
  }
  ...
  /**
   **/
  public TaskCollectionTaskCollection membersodataCount(Odata400Count membersodataCount) {
  ...
  /**
   **/
  public TaskCollectionTaskCollection membersodataNavigationLink(Odata400IdRef membersodataNavigationLink) {
  ...
  /**
   **/
  public TaskCollectionTaskCollection name(ResourceName name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public TaskCollectionTaskCollection oem(ResourceOem oem) {
    this.oem = oem;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TaskCollectionTaskCollection taskCollectionTaskCollection = (TaskCollectionTaskCollection) o;
    return Objects.equals(this.odataContext, taskCollectionTaskCollection.odataContext) &&
        Objects.equals(this.odataId, taskCollectionTaskCollection.odataId) &&
        Objects.equals(this.odataType, taskCollectionTaskCollection.odataType) &&
        Objects.equals(this.description, taskCollectionTaskCollection.description) &&
        Objects.equals(this.members, taskCollectionTaskCollection.members) &&
        Objects.equals(this.membersodataCount, taskCollectionTaskCollection.membersodataCount) &&
        Objects.equals(this.membersodataNavigationLink, taskCollectionTaskCollection.membersodataNavigationLink) &&
        Objects.equals(this.name, taskCollectionTaskCollection.name) &&
        Objects.equals(this.oem, taskCollectionTaskCollection.oem);
  }
  ...
  public String toString() {
    ...
    sb.append("class TaskCollectionTaskCollection {\n");
