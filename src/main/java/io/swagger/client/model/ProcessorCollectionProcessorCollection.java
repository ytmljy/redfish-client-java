...
import io.swagger.client.model.ProcessorProcessor;
...
public class ProcessorCollectionProcessorCollection   {
  ...
  private List<ProcessorProcessor> members = new ArrayList<ProcessorProcessor>();
  ...
  /**
   **/
  public ProcessorCollectionProcessorCollection odataContext(Odata400Context odataContext) {
  ...
  /**
   **/
  public ProcessorCollectionProcessorCollection odataId(Odata400Id odataId) {
  ...
  /**
   **/
  public ProcessorCollectionProcessorCollection odataType(Odata400Type odataType) {
  ...
  /**
   **/
  public ProcessorCollectionProcessorCollection description(ResourceDescription description) {
   ...
   **/
  public ProcessorCollectionProcessorCollection members(List<ProcessorProcessor> members) {
  ...
  public List<ProcessorProcessor> getMembers() {
    return members;
  }
  public void setMembers(List<ProcessorProcessor> members) {
    this.members = members;
  }
  ...
  /**
   **/
  public ProcessorCollectionProcessorCollection membersodataCount(Odata400Count membersodataCount) {
  ...
  /**
   **/
  public ProcessorCollectionProcessorCollection membersodataNavigationLink(Odata400IdRef membersodataNavigationLink) {
  ...
  /**
   **/
  public ProcessorCollectionProcessorCollection name(ResourceName name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ProcessorCollectionProcessorCollection oem(ResourceOem oem) {
    this.oem = oem;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProcessorCollectionProcessorCollection processorCollectionProcessorCollection = (ProcessorCollectionProcessorCollection) o;
    return Objects.equals(this.odataContext, processorCollectionProcessorCollection.odataContext) &&
        Objects.equals(this.odataId, processorCollectionProcessorCollection.odataId) &&
        Objects.equals(this.odataType, processorCollectionProcessorCollection.odataType) &&
        Objects.equals(this.description, processorCollectionProcessorCollection.description) &&
        Objects.equals(this.members, processorCollectionProcessorCollection.members) &&
        Objects.equals(this.membersodataCount, processorCollectionProcessorCollection.membersodataCount) &&
        Objects.equals(this.membersodataNavigationLink, processorCollectionProcessorCollection.membersodataNavigationLink) &&
        Objects.equals(this.name, processorCollectionProcessorCollection.name) &&
        Objects.equals(this.oem, processorCollectionProcessorCollection.oem);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessorCollectionProcessorCollection {\n");
